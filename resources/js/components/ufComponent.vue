    ...
    <div>
        <div class="col-12 col-md-7 mx-auto ">
                <div class="form-wrap">
                    ...
                    <select id="user_tamanio_empresa" v-model="tamanio" name="user-tamanio" class="form-input">
                    ...
                    <p id="user_tamanio_empresa_error" class="text-danger my-0 pb-1 pl-4 small">&nbsp</p>
                </div>
        </div>     
    </div>
</template>
