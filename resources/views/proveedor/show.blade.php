                    ...
                    <div class="col-12 mt-2 mt-2">
                      ...
                      <form  action="{{ route('send') }}" method="POST">
                        ...
                        <div class="col-md-12 p-2 mt-0">
                          <p>Correo {{$em->des}}</p>
                          @if($em->correo!='')
                          <input class="form-input" readonly class="pt-3 pb-3 pl-0 col-md-6 col-12" name="correo" value="{{$em->correo}}">
                          <input  type="hidden" name="rut" value="{{ $em->proveedor_rut }}">
                          ...
                          @else
                          <input class="form-input" readonly class="pt-3 pb-3 pl-0 col-md-6 col-12" name="correo" value="Sin registro">                
                          @endif
                        </div> 
                    </form>
                    </div>
